package com.example.a1171832jumanafinalproj.ui.special;
...
import com.example.a1171832jumanafinalproj.ui.car.HomeViewModel;
...
public class SpecialOffersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) root.findViewById(R.id.special_rv);
        LinearLayoutManager layoutManager = new LinearLayoutManager(requireActivity()); //moved it to here
        ...
        System.out.println("Special "+ carsList.size());
