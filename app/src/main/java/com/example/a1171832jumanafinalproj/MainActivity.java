...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_car, R.id.nav_reservations, R.id.nav_favourites, R.id.nav_profile)
        ...
        NavDestination demoDestination = graph.findNode(R.id.nav_profile);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id == R.id.nav_call) {
                    ...
                    final BottomSheetDialog bottomSheetDialog3 = new BottomSheetDialog(MainActivity.this, R.style.BottomSheetDialogTheme
                    );
                    View bottomSheetView3 = LayoutInflater.from(MainActivity.this)
                            .inflate(
